...
func NewListener(addr string, scheme string, tlsinfo *TLSInfo) (l net.Listener, err error) {
...
type TLSInfo struct {
	...
	parseFunc func([]byte, []byte) (tls.Certificate, error) //解析tls得key
...
// copied from golang.org/x/netmodule/http2/http2.go
